...
public interface RefundService {
  Page<RefundRequestResponse> getRefundRequests(RefundStatus status, BookingType bookingType, Pageable pageable);

  RefundRequestResponse processRefund(UUID refundId, ProcessRefundRequest request, UUID coordinatorId);

  RefundRequestResponse rejectRefund(UUID refundId, RejectRefundRequest request, UUID coordinatorId);
}
