...
public class AdminUserController extends AbstractBaseController {
    ...
    public ResponseEntity<SingleResponse<Page<BaseUserProfileResponse>>> getAllUsers(
            ...
            Pageable pageable) {
        return success(adminUserService.getAllUsers(role, status, pageable), "Users fetched successfully");
    }

    @GetMapping("/{id}")
    public ResponseEntity<SingleResponse<BaseUserProfileResponse>> getUserDetail(@PathVariable UUID id) {
    ...
    public ResponseEntity<SingleResponse<BaseUserProfileResponse>> updateGuideProfile(
        ...
        return success(adminUserService.updateGuideProfile(id, request), "Guide profile updated successfully");
    }

    @PatchMapping("/coordinators/{id}")
    public ResponseEntity<SingleResponse<BaseUserProfileResponse>> updateCoordinatorProfile(
            @PathVariable UUID id,
            @Valid @RequestBody UpdateCoordinatorProfileRequest request) {
        return success(adminUserService.updateCoordinatorProfile(id, request),
    ...
    public ResponseEntity<SingleResponse<BaseUserProfileResponse>> updateReceptionistProfile(
        ...
        return success(adminUserService.updateReceptionistProfile(id, request),
