...
public class ReviewController extends AbstractBaseController {
  ...
  public ResponseEntity<SingleResponse<Page<ReviewResponse>>> getHotelReviews(
      @PathVariable UUID hotelId, @PageableDefault(size = 10) Pageable pageable) {
    Page<ReviewResponse> reviews =
        reviewService.getReviews(hotelId, ReviewTargetType.HOTEL, pageable);
  ...
  public ResponseEntity<SingleResponse<Page<ReviewResponse>>> getTourReviews(
      @PathVariable UUID tourId, @PageableDefault(size = 10) Pageable pageable) {
    Page<ReviewResponse> reviews =
        reviewService.getReviews(tourId, ReviewTargetType.TOUR, pageable);
  ...
  public ResponseEntity<SingleResponse<Page<ReviewResponse>>> getRouteReviews(
      @PathVariable UUID routeId, @PageableDefault(size = 10) Pageable pageable) {
    Page<ReviewResponse> reviews =
        reviewService.getReviews(routeId, ReviewTargetType.ROUTE, pageable);
