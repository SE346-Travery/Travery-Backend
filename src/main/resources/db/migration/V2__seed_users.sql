...
-- 1. ADMIN
-- =============================================
INSERT INTO users (id, full_name, email, password_hashed, role, status, auth_provider, created_at, updated_at)
VALUES (
...
INSERT INTO hotels (id, name, address, city_province, star_rating, latitude, longitude, created_at, updated_at)
VALUES (
