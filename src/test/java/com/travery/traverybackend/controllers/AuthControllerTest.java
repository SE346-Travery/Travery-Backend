...
public class AuthControllerTest {
    ...
    static class TestConfig {
        ...
        public UserDetailsService userDetailsService() {
            return email -> CustomUserDetails.builder()
                    .userId(TEST_USER_ID)
                    .email(email)
                    .isEnabled(true)
    ...
    public void deleteAccount_ShouldReturnSuccess() throws Exception {
        ...
        doNothing().when(authService).deleteAccount(eq(TEST_USER_ID), any(AccountDeletionRequest.class), eq("Bearer mock-token"));

        mockMvc.perform(post("/auth/account-deletion")
