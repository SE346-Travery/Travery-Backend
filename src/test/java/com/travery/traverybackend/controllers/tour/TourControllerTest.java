...
public class TourControllerTest {
    ...
    void createTemplate_returnsCreated() throws Exception {
        TourTemplateRequest request = TourTemplateRequest.builder()
                .name("Dalat Trip")
        ...
        when(tourService.createTemplate(any(TourTemplateRequest.class), any(), any(), eq(coordinatorId)))
                .thenReturn(response);
        ...
        org.springframework.mock.web.MockMultipartFile dataFile = new org.springframework.mock.web.MockMultipartFile(
